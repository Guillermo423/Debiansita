...
\addbibresource{dune-command-line-references.bib}

\title{
	Introducción al emulador de terminal~\terminal{}
}
\subtitle{
	Parte I:
	\lstinline{bash},
...
\newcommand{\linux}{%
	\begingroup\normalfont
	\includegraphics[height=2\fontcharht\font`B]{linux}%
	\endgroup
}

\newcommand{\gnu}{%
	\begingroup\normalfont
	\includegraphics[height=2\fontcharht\font`B]{gnu}%
	\endgroup
}

\newcommand{\terminal}{%
	\begingroup\normalfont
	\includegraphics[height=2\fontcharht\font`B]{terminal}%
	\endgroup
}